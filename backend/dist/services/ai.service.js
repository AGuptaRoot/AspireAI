 ...
 */
export function parseJsonSafely(rawText, fallback) {
 ...
 */
export const getChatModel = (temperature = config.Gemini.Temperature ?? 0.2, jsonMode = false, maxTokens = config.Gemini.MaxTokens ?? 3000) => {
...
export const generateReviewedAnalysisWithFallback = async (rawText, fileName = "Resume.pdf") => {
 ...
 */
export const generateMcqQuestionsForField = async (field, difficulty = "Mid-Level", resumeContext = "") => {
 ...
 */
export const generateHeuristicInterviewQuestions = (field, _difficulty = "Mid-Level") => {
 ...
 */
export const generateResumeWithAi = async ({ existingResumeText, targetRole = "Full Stack Developer", userName = "Candidate", userEmail = "candidate@example.com", customInstructions = "", }) => {
 ...
 */
export const generateFallbackResume = (targetRole = "Full Stack Developer", userName = "Candidate", userEmail = "candidate@example.com", existingText) => {
...
export async function* streamResumeWithAi(params) {
    const { existingResumeText, targetRole = "Full Stack Developer", userName = "Candidate", userEmail = "candidate@example.com", customInstructions = "", } = params;
